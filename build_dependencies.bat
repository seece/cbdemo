...
%pythonpath% %cbpp_path% %compile_flags% --flags=BUILD_AS_LIB;_RELEASE;OCULUSRIFT src\editor.cbpp %sourcedir%\inc\editor_oculusrift_release.cb -d %current%src\
%pythonpath% %cbpp_path% %compile_flags% --flags=BUILD_AS_LIB;_DEBUG;OCULUSRIFT src\editor.cbpp %sourcedir%\inc\editor_oculusrift.cb -d %current%src\
